            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="movieinfo.php?movie=21">
                        <img src="images/blink twice.jpg" alt="movie 1" class="img-fluid">
                    </a>
                    <?php
                ...
                <div class="col-md-3">
                    ...
                    <a href="movieinfo.php?movie=22">
                        <img src="images/Intrusion (2021).jpg" alt="movie 2" class="img-fluid">
                    </a>
                    <?php
                ...
                <div class="col-md-3">
                    ...
                    <a href="movieinfo.php?movie=23">
                        <img src="images/Fractured.jpg" alt="movie 3" class="img-fluid">
                    </a>
                    <?php
                ...
                <div class="col-md-3">
                    ...
                    <a href="movieinfo.php?movie=25">
                        <img src="images/Alone.jpg" alt="movie 4" class="img-fluid">
                    </a>
                    <?php
